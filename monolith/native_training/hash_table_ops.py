...
from monolith.native_training import monolith_ops
...
hash_table_ops = monolith_ops.monolith_ops
...
def fused_apply_gradient(tables: List[tf.Tensor],
                         ids: tf.Tensor,
...
def hash_table_from_config(config: entry.HashTableConfigInstance,
  ...
  return HashTable(hash_table_ops.monolith_hash_table(
