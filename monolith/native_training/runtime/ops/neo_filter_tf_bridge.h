...
#ifndef MONOLITH_NATIVE_TRAINING_RUNTIME_OPS_NEO_FILTER_TF_BRIDGE
#define MONOLITH_NATIVE_TRAINING_RUNTIME_OPS_NEO_FILTER_TF_BRIDGE
#include <cstdint>
#include <memory>
...
#include "monolith/native_training/runtime/neo_filter/filter.h"
#include "monolith/native_training/runtime/ops/file_utils.h"

namespace tensorflow {
namespace monolith_tf {

class NeoFilterTfBridge : public ResourceBase {
 public:
  explicit NeoFilterTfBridge(
      std::unique_ptr<neo::Filter> filter,
 ...
 private:
  ...
  std::unique_ptr<neo::Filter> filter_;
...
struct HashFilterAsyncPack {
  HashFilterAsyncPack(OpKernelContext* p_ctx, NeoFilterTfBridge* p_hash_filter,
...
#endif  // MONOLITH_NATIVE_TRAINING_RUNTIME_OPS_NEO_FILTER_TF_BRIDGE
