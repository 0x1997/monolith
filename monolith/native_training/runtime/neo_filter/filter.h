...
#ifndef MONOLITH_NATIVE_TRAINING_RUNTIME_SLIDING_HASH_FILTER_FILTER
#define MONOLITH_NATIVE_TRAINING_RUNTIME_SLIDING_HASH_FILTER_FILTER
#include <string>
...
#endif  // MONOLITH_NATIVE_TRAINING_RUNTIME_SLIDING_HASH_FILTER_FILTER
