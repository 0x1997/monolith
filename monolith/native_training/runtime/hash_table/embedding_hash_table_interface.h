...
class EmbeddingHashTableInterface {
 public:
  ...
  virtual void BatchLookup(absl::Span<int64_t> ids,
  ...
  virtual void Lookup(int64_t id, absl::Span<float> embedding) const = 0;
...
class DefaultEmbeddingHashTableDecorator : public EmbeddingHashTableInterface {
 public:
  ...
  void BatchLookup(absl::Span<int64_t> ids,
  ...
  void Lookup(int64_t id, absl::Span<float> embedding) const override {
