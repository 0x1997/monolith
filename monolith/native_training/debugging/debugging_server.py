...
clip_ops = tf.load_op_library(
    get_libops_path("monolith/native_training/runtime/ops/clip_ops.so"))

filter_ops = tf.load_op_library(
    get_libops_path("monolith/native_training/runtime/ops/hash_filter_ops.so"))

filter_save_op = tf.load_op_library(
    get_libops_path(
        "monolith/native_training/runtime/ops/hash_filter_save_op.so"))

filter_restore_op = tf.load_op_library(
    get_libops_path(
        "monolith/native_training/runtime/ops/hash_filter_restore_op.so"))

monolith_custom_ops = tf.load_op_library(
    get_libops_path("monolith/native_training/monolith_custom_ops.so"))

training_ops = tf.load_op_library(
    get_libops_path("monolith/native_training/optimizers/training_ops.so"))

pb_datasource_ops = tf.load_op_library(
    get_libops_path(
