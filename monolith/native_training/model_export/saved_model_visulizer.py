...
hash_table_ops = tf.load_op_library(
    "monolith/native_training/runtime/ops/hash_table_ops.so")
gen_distribution_ops = tf.load_op_library(
    "monolith/native_training/runtime/ops/distribution_ops.so")
