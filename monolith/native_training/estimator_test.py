...
export_base = "{}/{}/ckpt/exported_models".format(get_test_tmp_dir(), model_name)
conf = RunnerConfig(is_local=True, num_ps=0, model_dir=model_dir, use_native_multi_hash_table=False)
