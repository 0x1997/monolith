...
VALID_FNAMES = [1, 2, 3, 4, 5, 6, 7, 8, 81, 82, 83, 84, 86, 87, 88, 89, 92, 93, 110, 115, 205, 208, 209, 301, 302, 303, 304,
                305, 306, 307, 308, 309, 310, 311, 312, 313, 314, 315, 316, 501, 502, 503, 504, 505, 506, 507, 508, 509, 510,
                511, 512, 513, 514, 515, 516, 517, 518, 519, 520, 521, 522, 523, 526, 527, 528, 529, 530, 531, 532, 533, 534,
                536, 537, 538, 540, 542, 543, 544, 549, 562, 564, 565, 567, 568, 569, 573, 576, 577, 700, 701, 707, 708, 709,
                710, 711, 712, 719, 720, 800, 801, 802, 803, 804, 805, 806, 807, 808, 809, 810, 811, 812, 813, 814, 815, 816,
                817, 818, 819, 820, 821, 822, 823, 824, 825, 826, 828, 829, 830, 832, 834, 835, 836, 837, 838, 839, 840, 841,
                ...
                886, 887, 888, 889, 890, 891, 892, 893, 894, 895, 896, 897, 898, 899, 900, 901, 903, 905, 906, 907, 908, 909,
                910, 911, 912, 913, 914, 915, 918, 924, 925, 926, 927, 928, 929, 930, 932, 933, 934, 935, 937, 938, 939, 940,
                941, 942, 944, 946, 947, 948, 949, 950, 951, 952, 954, 955, 956, 958, 959, 960, 961, 962, 963, 964, 965, 966,
                967, 968, 969, 970, 971, 972, 973, 974, 975, 976, 977, 978, 979, 980, 981, 982, 983, 984, 1001, 1002, 1003,
    ...
    if FLAGS.data_gen:
      ...
      for i in range(FLAGS.num_batch):
        for j in range(BATCH_SIZE):
          ...
          producer.send(topic=FLAGS.topic, value=pack(fmt, len(inst_str), inst_str))
      producer.close()

  def test_kafka_dataset(self):
    dataset = KafkaDataset(topics=FLAGS.topic, group_id=FLAGS.group_id, servers=FLAGS.kafka_servers,
