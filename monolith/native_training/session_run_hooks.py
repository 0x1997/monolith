...
class CustomGlobalStepWaiterHook(tf.estimator.SessionRunHook):
  ...
  def __init__(self,
    ...
    self._non_tide_wait_second = random.randint(int(max_non_tide_wait_minute * 6), max_non_tide_wait_minute * 60)
  ...
  def before_run(self, run_context):
    ...
    while True:
      ...
      if self._hook_start_time is not None and time.time() - self._hook_start_time > self._non_tide_wait_second:
        return None
