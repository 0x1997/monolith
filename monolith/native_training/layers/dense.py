...
class Dense(Layer):
  ...
  def __init__(self,
    ...
    self.kernel_initializer = initializers.get(kernel_initializer or 'glorot_uniform')
  ...
  def get_variable(self,
    ...
    with tf.compat.v1.variable_scope(cur_name_scope, reuse=tf.compat.v1.AUTO_REUSE):
  ...
  def call(self, inputs, **kwargs):
    ...
    if self.inactive_relu_monitor:
      inactive_relu_count = self.units - tf.math.count_nonzero(
          output,
          axis=0)
