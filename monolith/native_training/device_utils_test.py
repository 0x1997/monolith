...
class DeviceUtilsTest(tf.test.TestCase):
  ...
  def test_process_gpu_map(self):
    self.assertEqual(device_utils.get_visible_gpus(local_rank=2, processes_per_gpu=1), "2")
    self.assertEqual(device_utils.get_visible_gpus(local_rank=1, processes_per_gpu=2), "0")
    self.assertEqual(device_utils.get_visible_gpus(local_rank=2, processes_per_gpu=2), "1")
    self.assertEqual(device_utils.get_visible_gpus(local_rank=3, processes_per_gpu=2), "1")
