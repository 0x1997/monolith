...
"""
bazel run monolith/agent_service:agent_controller -- --bzid=yijie_test --cmd=decl --export_base=/tmp/yijie.zhu/test_ffm_model/exported_models --overwrite=0
bazel run monolith/agent_service:agent_controller -- --bzid=yijie_test --cmd=pub --model_name=test_ffm_model --layout_base=test_layout_1 --shard_num=-1
bazel run monolith/agent_service:agent_controller -- --bzid=yijie_test --cmd=unpub --model_name=test_ffm_model --layout_base=test_layout_1 --shard_num=-1

bazel run monolith/agent_service:agent_controller -- --bzid=yijie_test --cmd=bzid_info
bazel run monolith/agent_service:agent_controller -- --bzid=yijie_test --cmd=model_info --model_name=test_ffm_model
"""
import json
import os
import fnmatch
