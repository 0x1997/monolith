...
def get_cmd_and_port(config: AgentConfig, conf_path: str = None, 
                     server_type: str = None, config_file: str = None):
  if server_type == TFSServerType.PS:
    return config.get_cmd_and_port(TFS_BINARY, server_type=TFSServerType.PS, config_file=config_file)
  elif server_type == TFSServerType.ENTRY:
    return config.get_cmd_and_port(TFS_BINARY, server_type=TFSServerType.ENTRY, config_file=config_file)
  else:
