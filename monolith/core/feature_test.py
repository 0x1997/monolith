...
class FeatureColumnV1Test(tf.test.TestCase):
  ...
  def test_merge_split_vector_in_same_slot(self):
    ...
    self.assertTrue(fs_1._merged_feature_slices[0] in fc_1._merged_feature_slice_to_tf_placeholder)
    self.assertTrue(fs_1._merged_feature_slices[1] in fc_1._merged_feature_slice_to_tf_placeholder)
    self.assertTrue(fs_2._merged_feature_slices[0] in fc_2._merged_feature_slice_to_tf_placeholder)
    self.assertTrue(fs_3._merged_feature_slices[0] in fc_3._merged_feature_slice_to_tf_placeholder)
    self.assertTrue(fs_4._merged_feature_slices[0] in fc_4._merged_feature_slice_to_tf_placeholder)
    self.assertTrue(fs_4._merged_feature_slices[1] in fc_4._merged_feature_slice_to_tf_placeholder)
    self.assertTrue(fs_4._merged_feature_slices[0] in fc_5._merged_feature_slice_to_tf_placeholder)
    ...
    env._tpu_features["fc_name_4_1"] = tf.constant([[13, 14, 15, 16, 17, 18, 19, 20, 21]])
    env._tpu_features["fc_name_5_0"] = tf.constant([[12]])
    env._tpu_features["fc_name_5_1"] = tf.constant([[13, 14, 15, 16, 17, 18, 19, 20, 21]])
